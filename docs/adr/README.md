...
| [0013](0013-android-client-architecture.md) | Four shared `core` modules; features are packages | Accepted · amended ×1 (latest 2026-09-06) |
| [0014](0014-watch-pairing-address-handoff.md) | The phone carries the address; the watch mints its own token | Accepted · amended ×1 (latest 2026-09-16) |
